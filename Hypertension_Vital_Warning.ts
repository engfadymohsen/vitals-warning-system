...
class Hypertension_Vital_Warning{
    ...
    // [1] GENERAL FUNCTION
    // --------------------
    HTN_Vitals_Display_Message(Systolic:number, Diastolic:number): string{
    ...
    // --------------------------------
    Borderline_Hypotension_Question_Result(Borderline_Hyptension_Question_Answer:number):string{
        ...
        else        return "Error in Borderline Hypotension Question Result"
...
let testValues = [
    { Systolic: 190, Diastolic: 100 },  // Expected: Hypertensive Urgency or Emergency.
    { Systolic: 80,  Diastolic: 75 },   // Expected: Hypotension.
    { Systolic: 105, Diastolic: 85 },   // Expected: Borderline Hypotension Question Result.
    { Systolic: 165, Diastolic: 95 },   // Expected: Uncontrolled Hypertension & recommendation.
    { Systolic: 145, Diastolic: 88 },   // Expected: Poorly Controlled Hypertension advice.
    { Systolic: 135, Diastolic: 82 },   // Expected: Partially Controlled Hypertension advice.
